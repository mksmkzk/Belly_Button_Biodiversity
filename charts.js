...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    let filteredSamples = samples.filter(sampleObj => sampleObj.id == sample)[0];
    ...
    var washingFrequency = parseFloat(data.metadata.filter(sampleObj => sampleObj.id == sample)[0].wfreq);
